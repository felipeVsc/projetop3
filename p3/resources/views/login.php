    ...
    <div class="d-flex align-items-center flex-column">
        ...
        <div class="p-2">
            <div class="form-floating mb-4">
                ...
                <label for="floatingInput" style="padding-left: 40%;color: grey;">Usuário</label>
            </div>
        ...
        <div class="p-2" ><button style="padding-right: 130px;padding-left:130px; background-color: #12E58D !important; border-color: #12E58D !important;" class="btn btn-primary rounded-pill largurabotoes" type="submit" >Entrar</button></div>
